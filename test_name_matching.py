...
This tests that names like "林挺" should NOT match "林正挺".
"""
...
def test_chinese_name_strict_matching():
    ...
    # Test Case 1: "林挺" should NOT match "林正挺"
    ...
    candidate = PersonProfile(
        name="林正挺",  # Different name (3 chars vs 2 chars)
        affiliations=["清华大学"],
        research_interests=["机器学习"],
        education=[],
        coauthors=[],
    ...
    assert not result.is_match, "FAILED: '林挺' should NOT match '林正挺'"
